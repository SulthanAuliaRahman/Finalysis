    ...
    protected function instructions(): string
    {
        return (string) new SystemPrompt(
            ...
            steps: [
                ...
                "Jalin sebab-akibat antar akun jika relevan (misal: Pendapatan naik tapi Beban naik lebih cepat mengindikasikan tekanan pada efisiensi operasional; atau Total Aset naik dibarengi Total Liabilitas naik lebih cepat dari Total Ekuitas mengindikasikan ekspansi dibiayai utang) — bukan cuma deskripsi angka terpisah per akun.",
