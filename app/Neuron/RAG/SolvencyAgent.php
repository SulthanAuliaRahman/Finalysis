...
class SolvencyAgent extends BaseRagAgent
{
    protected function instructions(): string
    {
        return (string) new SystemPrompt(
            background: [
                "Kamu adalah agent, analis manajemen risiko leverage pendanaan modal jangka panjang.",
            ...
            steps: [
                ...
                "Setiap rasio WAJIB menjalin 4 Lapis Penjelasan ke dalam 2 paragraf tersebut secara alami, TANPA label/judul eksplisit per lapis dan TANPA bullet point: (1) Angka & cara hitung, (2) Perbandingan batas konservatif aman (DER <= 1.00 dan DAR <= 0.50.), (3) Implikasi apakah struktur modal konservatif ini aman atau justru kurang berani ambil risiko utang produktif, (4) Rekomendasi pembiayaan masa depan.",
