...
class LiquidityAnalystAgent extends BaseRagAgent
{
    protected function instructions(): string
    {
        return (string) new SystemPrompt(
            background: [
                "Kamu adalah agent, spesialis analisis risiko keuangan jangka pendek korporasi.",
            ...
            steps: [
                ...
                "Setiap sub-rasio WAJIB menjalin 4 Lapis Penjelasan ke dalam 2 paragraf tersebut secara alami, TANPA label/judul eksplisit per lapis dan TANPA bullet point: (1) Angka & cara hitung, (2) bandingkan secara ketat dengan benchmark bertingkat berikut — Current Ratio: >= 1.5 sehat, >= 2.0 sangat baik, < 1.0 berisiko, namun WASPADAI jika > 3.0 karena mengindikasikan idle assets; Quick Ratio: >= 1.0 sehat, < 0.5 berisiko tinggi; Cash Ratio: >= 0.2 (ukuran paling ketat, jarang dipakai sebagai satu-satunya acuan)., (3) Implikasi bagi perusahaan, (4) Rekomendasi konkret.",
