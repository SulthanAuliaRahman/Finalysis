...
export const TrendCommonsizeCard = forwardRef(function TrendCommonsizeCard({ data, perusahaanId, analisisId,sectionStatus, canRegenerasi, onRegenerasiStart}, ref) {
